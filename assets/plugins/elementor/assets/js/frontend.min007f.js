            ...
            class Frontend extends elementorModules.ViewModule {
                ...
                addListenerOnce(e, t, n, i) {
                    if ((i || (i = this.elements.$window), this.isEditMode()))
                        if (
                            (this.removeListeners(e, t, i), i instanceof jQuery)
                        ) {
                            const s = t + "." + e;
                            i.on(s, n);
                        } else i.on(t, n, e);
                ...
                removeListeners(e, t, n, i) {
                    if (
                        (i || (i = this.elements.$window), i instanceof jQuery)
                    ) {
                        const s = t + "." + e;
                        i.off(s, n);
                    } else i.off(t, n, e);
                ...
                waypoint(e, t, n) {
                    ...
                    return e.elementorWaypoint(function () {
                        ...
                        return (
                            n.triggerOnce && this.destroy && this.destroy(), i
                        );
                    }, n);
                }
                muteMigrationTraces() {
                            ...
                            onStateChange: (t) => {
                                switch (t.data) {
                                    ...
                                    case e.PlayerState.ENDED:
                                        this.player.seekTo(
                                            i.background_video_start || 0
                                        ),
                                            i.background_play_once &&
                                                this.player.destroy();
                                }
                            },
                        },
            ...
            e.exports = elementorModules.ViewModule.extend({
                getDefaultSettings: () => ({
                    ...
                    selectors: {
                        ...
                        scrollable: (0, i.isScrollSnapActive)()
                            ? "body"
                            : "html, body",
                    },
                }),
                    ...
                    return (
                        Object.keys(e.breakpoints).forEach((i) => {
                            ...
                            if (
                                ...
                                !t.widescreen ||
                                (s !== t.widescreen.value &&
                                    s + 1 !== t.widescreen.value)
                            ) {
                                const e = n.findIndex(
                                    (e) => s === e || s + 1 === e
                                );
