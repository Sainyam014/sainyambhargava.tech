jQuery(document).ready(function ($) {
    ...
    $("body").on(
        "vclick touchstart keypress",
        ".mob-nav-wrapp .sub-toggle",
        function () {
    ...
    $("body").on(
        ...
        ".mob-nav-wrapp .sub-toggle-children",
        function () {
            $(this).next().next("ul.sub-menu").slideToggle(400);
        }
    );
        ...
        _doc.addEventListener("keydown", function (event) {
            ...
            if (_doc.body.classList.contains("toggled-modal")) {
                ...
                if (".menu-modal" === toggleTarget) {
                    ...
                    elements.unshift(
                        _doc.querySelector(".mob-outer-wrapp .toggle-wrapp")
                    ); //mobile toggle

                    bottomMenu = _doc.querySelector(
                        ".mob-outer-wrapp .menu-last"
                    ); //mobile menu last div
